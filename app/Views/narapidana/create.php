...
<?= $this->section('breadcrumb') ?>
    ...
    <li class="breadcrumb-item active">Tambah Narapidana</li>
<?= $this->endSection() ?>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Tambah Data Narapidana Baru</h3>
                </div>
                <div class="card-body">
                    ...
                    <form method="post" action="<?= base_url('admin/narapidana/store') ?>">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control" required>
                                        ...
                                        <option value="Bebas" <?= old('status') == 'Bebas' ? 'selected' : '' ?>>Bebas</option>
