        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="<?= base_url('admin/periode/update/' . $periode['id']) ?>">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="tahun" name="tahun" 
                                           value="<?= old('tahun', $periode['tahun']) ?>" required min="2021" max="2030">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="keterangan" name="keterangan" rows="3" 
                                              placeholder="Keterangan tambahan tentang periode ini"><?= old('keterangan', $periode['keterangan']) ?></textarea>
