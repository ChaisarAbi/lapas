    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Tambah Subkriteria Baru</h3>
                </div>
                <div class="card-body">
                    ...
                    <form action="<?= base_url('tpp/subkriteria/store') ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Simpan Subkriteria
                            </button>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <h5><i class="fas fa-info-circle text-info"></i> Tentang Subkriteria</h5>
                    <p>Subkriteria adalah detail dari kriteria penilaian yang lebih spesifik.</p>
                    
                    <h5><i class="fas fa-balance-scale text-success"></i> Jenis Subkriteria</h5>
                    <ul>
                    ...
                    <ul>
                        ...
                        <li>Kode subkriteria harus unik per kriteria</li>
                        <li>Bobot dapat diatur ulang di menu <strong>Lihat per Kriteria</strong></li>
                    </ul>
                    
                    <div class="alert alert-info">
                        <i class="icon fas fa-lightbulb"></i> <strong>Tip:</strong> Buat subkriteria yang spesifik dan terukur untuk penilaian yang akurat.
                    </div>
                </div>
            </div>
        </div>
