...
<?= $this->section('breadcrumb') ?>
    <li class="breadcrumb-item"><a href="<?= base_url('wali/dashboard') ?>">Dashboard</a></li>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm" style="width: 200px;">
                            <form method="get" action="<?= base_url('wali/hasil') ?>" class="form-inline">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-sm-6 col-12">
                                                <div class="info-box bg-success">
                                                    ...
                                                    <div class="info-box-content">
                                                        <span class="info-box-text">Baik (≥70)</span>
                                                        <span class="info-box-number"><?= $baikCount ?></span>
                                                        <div class="progress">
                                                            <div class="progress-bar" style="width: <?= $totalPenilaian > 0 ? ($baikCount / $totalPenilaian) * 100 : 0 ?>%"></div>
                                                        </div>
                                                        <span class="progress-description">
                                                            <?= $totalPenilaian > 0 ? number_format(($baikCount / $totalPenilaian) * 100, 1) : 0 ?>% dari total
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 col-12">
                                                <div class="info-box bg-warning">
                                                    ...
                                                    <div class="info-box-content">
                                                        <span class="info-box-text">Cukup (50-69)</span>
                                                        <span class="info-box-number"><?= $cukupCount ?></span>
                                                        <div class="progress">
                                                            <div class="progress-bar" style="width: <?= $totalPenilaian > 0 ? ($cukupCount / $totalPenilaian) * 100 : 0 ?>%"></div>
                                                        </div>
                                                        <span class="progress-description">
                                                            <?= $totalPenilaian > 0 ? number_format(($cukupCount / $totalPenilaian) * 100, 1) : 0 ?>% dari total
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 col-12">
                                                <div class="info-box bg-danger">
                                                    ...
                                                    <div class="info-box-content">
                                                        <span class="info-box-text">Perlu Perhatian (<50)</span>
                                                        <span class="info-box-number"><?= $perhatianCount ?></span>
                                                        <div class="progress">
                                                            <div class="progress-bar" style="width: <?= $totalPenilaian > 0 ? ($perhatianCount / $totalPenilaian) * 100 : 0 ?>%"></div>
                                                        </div>
                                                        <span class="progress-description">
                                                            <?= $totalPenilaian > 0 ? number_format(($perhatianCount / $totalPenilaian) * 100, 1) : 0 ?>% dari total
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <p class="text-muted">
                                <i class="fas fa-info-circle"></i> Data ini hanya untuk dilihat (read-only). Tidak ada akses untuk mengubah data.
                            </p>
                        </div>
                        <div class="col-md-6 text-right">
                            <a href="<?= base_url('wali/ranking?periode=' . $periode) ?>" class="btn btn-primary">
